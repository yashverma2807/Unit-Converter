...
//     if (unitType === "meters") {
//         result.innerHTML = "Converted value: " + (inputValue * 0.001) + " kilometers";
//     } else if (unitType === "kilometers") {
//         result.innerHTML = "Converted value: " + (inputValue * 1000) + " meters";
//     } else if (unitType === "feet") {
//         result.innerHTML = "Converted value: " + (inputValue * 0.0003048) + " kilometers";
//     } else if (unitType === "miles") {
//         result.innerHTML = "Converted value: " + (inputValue * 1.60934) + " kilometers";
//     }
// }
//
